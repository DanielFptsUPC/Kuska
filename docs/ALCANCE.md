...
- **ODS 11 — Ciudades y Comunidades Sostenibles** (principal): el proyecto organiza la respuesta urbana post-desastre.
- **ODS 13 — Acción por el Clima** (alternativo, si el track lo permite ampliar a desastres naturales en general).

Elegir uno solo al enviar el Writeup en Kaggle — se recomienda ODS 11 porque el pitch de "respuesta y resiliencia urbana" conecta más directo con lo que hace Kuska.
