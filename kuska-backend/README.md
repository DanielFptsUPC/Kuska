...
Scaffold FastAPI del backend de Kuska. Incluye los cuatro endpoints del contrato,
CORS, Swagger y un repositorio temporal en memoria con idempotencia por `client_id`.

## Ejecutar localmente

```powershell
Set-Location .\kuska-backend
python -m venv .venv
